...
(deftest let-form
  ...
  (lisp-to-js "(let [x 2] (* x x))"))))
(deftest let-lambda-function
  (is (= 
  "(function(times-five) { return times-five((5)) })(function (x) {return 
  (x*5)})" 
  (lisp-to-js "(let [times-five (fn [x] (* x 5))] (times-five 5))"))))
(deftest defn-form
  (is (= "function square(x) {return (x*x)}" 
  (lisp-to-js "(defn square [x] (* x x))"))))
...
(deftest ackermann-function
  (is (= 
  "function ackermann(m, n) {return 
  ((m==0)?(n+1):((n==0)?ackermann((m-1), 1):
